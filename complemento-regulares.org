...
** Gráfica de clanes
   ...
   de intersección de los clanes de \(G\). Es decir:
...
** Operaciones en gráficas
   ...
   - Si \(G\) y \(H\) son gráficas, denotamos con \(G\cup H\) a su
     *unión disjunta*.
   - Denotamos con \(G+H\) a la gráfica que se obtiene de \(G\cup H\)
...
** Ejemplo: Complementos de ciclos
   ...
   Todos los complementos de ciclos con al menos 4 vértices tienen una
   coafinación.
...
** Gráficas cúbicas con \(\leq\) 10 vértices
   ...
   - De las 17 divergentes, 9 tienen octaedro especial, 3 se retraen a
     la suspensión de \(C_{5}\), 3 tienen octaedro especial en
     \(K^{3}(G)\), 1 se retrae a la suspensión de \(C_{6}\) y 1 tiene
     \(K(G)\) con retracción a \(\overline{C_{10}}\).
   - Es notable que podamos determinar el comportamiento de todas.

** Gráficas cúbicas con 12 vértices

   - Hay 85 gráficas cúbicas conexas con 12 vértices y 9 disconexas.
   - De las 85 conexas, hay 40 que tienen un octaedro especial.
   - De las 45 que quedan, una se retrae a la suspensión de \(C_{5}\).
   - De las 44 que quedan, una se retrae a \(\overline{C_{8}}\).
   - Las 43 restantes se clanean, en 18 \(K(G)\) tiene octaedro especial.
   - No he podido determinar el comportamiento de las 25 restantes. 
  
** Tipo de homotopía

   - De las 25 restantes, 8 tienen el tipo de homotopía de \(S^{2}\),
     7 tienen el tipo de \(S^{2}\vee S^{2}\), 4 tienen el tipo de
     \(S^{2}\vee S^{2}\vee S^{2}\), 1 de \(S^{2}\vee S^{2}\vee
     S^{2}\vee S^{2}\), 1 de \(S^{3}\), una tiene la homología de
     \(S^{2}\) y otra la de \(S^{2}\vee S^{2}\).
   - Las restantes dos \(G\) son notables, pues son contraíbles, pero
     \(K(G)\) tiene el tipo de \(S^{3}\).
   - Estos resultados topológicos sugieren fuertemente que las 25
